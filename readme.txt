...
### What's Next
Checkout out our other projects for WordPress by author

[Plugins](https://profiles.wordpress.org/ujw0l/#content-plugins) - Free plugins

== Installation ==

1. Upload the folder `Social-Bar` and its contents to the `/wp-content/plugins/` directory or use the wordpress plugin installer
